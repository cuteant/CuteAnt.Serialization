...
namespace ServiceStack.Text
{
    public sealed class EmitReflectionOptimizer : ReflectionOptimizer
    {
        ...
        public override MemberGetter CreateGetter(PropertyInfo propertyInfo)
        {
            ...
            return (MemberGetter) getter.CreateDelegate(typeof(MemberGetter));
        }
        ...
        public override MemberGetter<T> CreateGetter<T>(PropertyInfo propertyInfo)
        {
            ...
            return (MemberGetter<T>) getter.CreateDelegate(typeof(MemberGetter<T>));
        }
        ...
        public override MemberSetter CreateSetter(PropertyInfo propertyInfo)
        {
            ...
            return (MemberSetter) setter.CreateDelegate(typeof(MemberSetter));
        }
        ...
        public override MemberRefSetter<T> CreateSetterRef<T>(FieldInfo fieldInfo) =>
